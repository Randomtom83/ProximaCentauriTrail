...
- Query the live graph first (GRAPHIFY_OUT=AgenticOS): `graphify query` for context, `graphify path` for relationships, `graphify explain` for concepts. Plan against the architecture that exists.
